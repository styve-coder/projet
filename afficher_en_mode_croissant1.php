  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active">
                <a href="basic_table.html">LIVRAISON</a>
              </li>
              <li>
                <a href="responsive_table.html">LIVREUR</a>
              </li>
              <li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <a href="basic_table.php"><button class="btn btn-success btn-xs">Tri normal</button></a>
        <div class="row mt">
          <div class="col-lg-12">
...
$limite = 10;
$debut = ($page - 1) * $limite;
$query = 'SELECT SQL_CALC_FOUND_ROWS * FROM livraison.livraison_du_produit ORDER BY id_livraison ASC LIMIT :limite OFFSET :debut';
